// pipeline destino 120D, desplegando en linux war y static-zip en 26
                   ...
                   script{
                     ...
                     ((deployTarget == 'Desarrollo') && (env.BRANCH_NAME.matches("RELEASE(.*)")))){
                        echo "*************************************************"
                         ...
                         libsfunctionsArtefactos.downloadArtefactoTotal(env.BRANCH_NAME, deployTarget, pathWS,versionInput)
                         sleep(10)
                     ...
                     ((deployTarget == 'Desarrollo') && (env.BRANCH_NAME.matches("RELEASE(.*)")))){
                         ...
                         libsProcesoDespliegueDESVAL.etapasDespliegueDESVAL_withMachineStatic(env.JOB_NAME, env.BRANCH_NAME,pathWS,deployTarget)
                     }
                   }
                   }
                 }
